...
function DateField(props: AriaDatePickerProps<DateValue>) {
  ...
  return (
    <div
      ...
      ref={ref}
      className={cn(
        'border-input ring-offset-background focus-visible:ring-ring inline-flex h-9 flex-1 items-center rounded-l-md bg-transparent px-3 py-2 text-sm shadow-sm transition-colors   focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-offset-1',
...
function TimeField(props: AriaTimeFieldProps<TimeValue>) {
  ...
  return (
    <div
      ...
      ref={ref}
      className={cn(
        'border-input focus-within:ring-ring focus-visible:ring-ring inline-flex h-9 w-full max-w-[5rem] flex-1 rounded-md border bg-transparent px-3 py-2 text-sm shadow-sm transition-colors focus-within:ring-1 focus-within:ring-offset-0 focus-visible:outline-none focus-visible:ring-1',
        props.isDisabled && 'cursor-not-allowed opacity-50',
      )}
    >
      {state.segments.map((segment, i) => (

...
const DialogCloseTopRight = React.forwardRef<
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Close
    ...
    {...props}
  >
    {/* {children ? children : <Cross2Icon className="h-4 w-4" />} */}
    <>
...
DialogCloseTopRight.displayName = 'DialogPrimitive.Close.displayName';
